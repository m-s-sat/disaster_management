var map = L.map('map').setView([20.5937, 82.9629], 5);
        ...
        document.querySelector(".search-btn").addEventListener("click",function(){
            ...
            const filteredEvents = earthquakeEvents.filter(event => event.year.toString() === year);
            ...
            if (filteredEvents.length === 0) {
                resultsContainer.innerHTML = "<strong>No earthquake events found for this year</strong>";
                hideResultsAfterDelay();
                return;
            }
        ...
        map.on('click', function(e) {
            ...
            let closestEvents = earthquakeEvents.filter(event =>
